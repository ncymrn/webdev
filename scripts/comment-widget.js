...
const s_stylePath = '/comment-widget-pink.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLSfuNA8-B5MrJiymnSjYFl1Dopw37u-ev2gjlQ_0e-wzBidXUg'; // The Google Form
const s_nameId = '256721714'; // The Name field ID
const s_websiteId = '445241646'; // The Website field ID
const s_textId = '1286793133'; // The Text field ID
const s_pageId = '178471493'; // The Page field ID
const s_replyId = '899076238'; // The Reply field ID
const s_sheetId = '18tUoZ0bLK4CawgsEEP1yw8ojOBrdFw_f0TqR9DhLOJ0'; // The Google Sheet
...
const s_filteredWords = [ // Add words to filter by putting them in quotes and separating with commas (ie. 'heck', 'dang')
    'heck', 'dang', 'nigger', 'nigga', 'nigg', 'kike'
]
